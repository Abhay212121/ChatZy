  ...
  return (
    <div>
      <button
        ...
        className="h-15 px-4 py-1 font-head1 text-xl rounded-md bg-[#4070F4] text-white absolute right-10 top-5 cursor-pointer hover:bg-[#4070f4db] duration-300 hover:scale-101"
      >
        Logout
      </button>
